...
import 'package:assignment6/models/chat_message.dart';
...
import 'package:assignment6/widgets/common_widgets.dart';
...
class _ChatDetailViewState extends State<ChatDetailView> {
  ...
  void uploadImageFile() async {
    ...
    UploadTask uploadTask =
        chatMessageProvider.uploadImageFile(imageFile!, fileName);
    try {
    ...
    return Flexible(
      child: groupChatId.isNotEmpty
          ? StreamBuilder<QuerySnapshot>(
              stream: chatMessageProvider.getChatMessage(groupChatId, _limit),
